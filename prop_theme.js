   ...
   // var query =  '((o.id=="738247")  && (o.state=="CHANDIGARH"))';
    ...
    if(query) {
     ...
     if(a.length>0) {
        ...
        check_data=this.state.check_dataOp.concat(item.label+'-'+type);
        this.setState({filterDynamicProp:data, check_dataOp:check_data});
     }
            ...
            <div className="collapsible-body" >
                   ...
                   {clas_props && <FilterResults
                          ...
                          {filteredItems => {
                            return(
                             <div style={{maxHeight:'150px', overflowY:'scroll', overflowX:'hidden'}} >    
                                {filteredItems.map(item => <div><span><input onClick={()=>{this.handleFiltereSelectProp(item, 'associated_class')}} style={{paddingRight:'5px', marginRight:'5px'}} type="checkbox" />{item.label}</span></div>)}
                             </div>   
                            )
                          }}
                        </FilterResults>}
                    ...
                    {!this.state.activeStatesOp && <ul>
                         {states_props && <FilterResults
                          ...
                          {filteredItems3 => {
                            return(
                             <div style={{maxHeight:'150px', overflowY:'scroll', overflowX:'hidden'}} >    
                                {filteredItems3.map(item3 => <div>{item3.label && <span><input style={{paddingRight:'5px', marginRight:'5px'}} onClick={()=>{this.handleFiltereSelectProp(item3, 'state')}} type="checkbox" />{item3.label}</span>}</div>)}
                             </div>   
                            )
                          }}
                        </FilterResults>}
                    ...
                    {!this.state.activeStatusOp && <ul>
                         {status_props && <FilterResults
                          ...
                          {filteredItems4 => {
                            return(
                             <div style={{maxHeight:'150px', overflowY:'scroll', overflowX:'hidden'}} >    
                                {filteredItems4.map(item4 => <div><span><input style={{paddingRight:'5px', marginRight:'5px'}} onClick={()=>{this.handleFiltereSelectProp(item4, 'status')}} type="checkbox" />{item4.label}</span></div>)}
                             </div>   
                            )
                          }}
                        </FilterResults>}
                    ...
                    {!this.state.activeTypeOp && <ul>
                         {type_props && <FilterResults
                          ...
                          {filteredItems5 => {
                            return(
                             <div style={{maxHeight:'150px', overflowY:'scroll', overflowX:'hidden'}} >    
                                {filteredItems5.map(item5 => <div><span><input style={{paddingRight:'5px', marginRight:'5px'}} onClick={()=>{this.handleFiltereSelectProp(item5, 'type')}} type="checkbox" />{item5.label}</span></div>)}
                             </div>   
                            )
                          }}
                        </FilterResults>}
                    ...
                    {!this.state.activeDOAOP && <ul>
                         {date_of_application && <FilterResults
                          ...
                          {filteredItems9 => {
                            return(
                              <div style={{maxHeight:'150px', overflowY:'scroll', overflowX:'hidden'}} >      
                                {filteredItems9.map(item9 => <div><span><input checked={this.state.check_dataOp.indexOf(item9.label+'-'+'application_date')!=-1} style={{paddingRight:'5px', marginRight:'5px'}} onClick={()=>{this.handleFiltereSelectProp(item9, 'application_date')}} type="checkbox" />{item9.label}</span></div>)}
                             </div>   
                            )
                          }}
                        </FilterResults>}
                    ...
                    {!this.state.activeDOUOP && <ul>
                         {date_of_usage && <FilterResults
                          ...
                          {filteredItems10 => {
                            return(
                              <div style={{maxHeight:'150px', overflowY:'scroll', overflowX:'hidden'}} >      
                                {filteredItems10.map(item10 => <div><span><input checked={this.state.check_dataOp.indexOf(item10.label+'-'+'date_of_usage')!=-1} style={{paddingRight:'5px', marginRight:'5px'}} onClick={()=>{this.handleFiltereSelectProp(item10, 'date_of_usage')}} type="checkbox" />{item10.label}</span></div>)}
                             </div>   
                            )
                          }}
                        </FilterResults>}
